class Category < ApplicationRecord
  ...
  # Validate that the category description and description are not empty.
    # Validate that the category description is not duplicated, or less than 5 characters.
